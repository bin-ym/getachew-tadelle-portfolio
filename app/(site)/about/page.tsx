    ...
    <main className="px-6 py-24 max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed text-base md:text-lg">
          <p>
            I am Getachew Tadelle, an Ethiopian artist and filmmaker. My work is
            born from spirituality, cultural identity, and inner consciousness.
          </p>

          <p>
            I was born in Yirgalem, and my artistic journey began in 2002 E.C.
            I taught myself through observation, practice, and spiritual
